...
export default class Client {
    ...
    static create(wallet, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const publicKeyBundle = new PublicKeyBundle(yield keystore.getPublicKeyBundle());
    ...
    static canMessage(peerAddress, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Array.isArray(peerAddress)) {
                ...
                const contacts = yield getUserContactsFromNetwork(new ApiClient(apiUrl, { appVersion: opts === null || opts === void 0 ? void 0 : opts.appVersion }), normalizedPeerAddresses);
                return contacts.map((contact) => !!contact);
            }
            try {
                peerAddress = utils.getAddress(peerAddress); // EIP55 normalize the address case.
    ...
    listInvitations(opts) {
        return this.listEnvelopes(buildUserInviteTopic(this.address), (env) => __awaiter(this, void 0, void 0, function* () { return env; }), opts);
    }
    /**
