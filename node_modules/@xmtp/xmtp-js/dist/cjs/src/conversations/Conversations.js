...
exports.ConversationCache = void 0;
...
exports.ConversationCache = ConversationCache;
/**
...
class Conversations {
    constructor(client) {
        ...
        this.v2Mutex = new async_mutex_1.Mutex();
    }
    /**
            ...
            return this.v1Cache.load(({ latestSeen }) => __awaiter(this, void 0, void 0, function* () {
                const seenPeers = yield this.getIntroductionPeers({
                    startTime: latestSeen
                        ...
                        : undefined,
                    direction: ApiClient_1.SortDirection.SORT_DIRECTION_ASCENDING,
                });
                return Array.from(seenPeers).map(([peerAddress, sent]) => new Conversation_1.ConversationV1(this.client, peerAddress, sent));
            }));
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { responses } = yield this.client.keystore.saveInvites({
                requests: envelopes.map((env) => ({
                    payload: (0, utils_1.b64Decode)(env.message),
                    timestampNs: long_1.default.fromString(env.timestampNs),
    ...
    conversationReferenceToV2(convoRef) {
        return new Conversation_1.ConversationV2(this.client, convoRef.topic, convoRef.peerAddress, (0, utils_1.nsToDate)(convoRef.createdNs), convoRef.context);
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decodeConversation = (env) => __awaiter(this, void 0, void 0, function* () {
                if (env.contentTopic === introTopic) {
                    const messageBytes = (0, utils_1.b64Decode)(env.message);
    ...
    getIntroductionPeers(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const topic = (0, utils_1.buildUserIntroTopic)(this.client.address);
            const messages = yield this.client.listEnvelopes(topic, (env) => {
                return Message_1.MessageV1.fromBytes((0, utils_1.b64Decode)(env.message));
            }, opts);
