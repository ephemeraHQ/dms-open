...
exports.PrivateKey = exports.AccountLinkedPrivateKey = exports.AccountLinkedPrivateKeyV1 = exports.SignedPrivateKey = void 0;
...
class AccountLinkedPrivateKeyV1 {
    constructor(obj) {
        if (!obj.secp256k1) {
            throw new Error('invalid private key');
        }
        ...
        this.publicKey = new PublicKey_1.AccountLinkedPublicKey(obj.publicKey);
        if (!(0, utils_1.equalBytes)(secp.getPublicKey(this.secp256k1.bytes), this.publicKey.secp256k1Uncompressed.bytes)) {
...
exports.AccountLinkedPrivateKeyV1 = AccountLinkedPrivateKeyV1;
class AccountLinkedPrivateKey extends AccountLinkedPrivateKeyV1 {
    constructor(obj) {
        if (obj.v1) {
            super(obj.v1);
            this.v1 = obj.v1;
    ...
    static fromLegacyKey(key, role) {
        return new AccountLinkedPrivateKey({
            v1: new AccountLinkedPrivateKeyV1({
                ...
                secp256k1: key.secp256k1,
                publicKey: PublicKey_1.AccountLinkedPublicKey.fromLegacyKey(key.publicKey, role),
            }),
        });
    }
    // derive shared secret from peer's PublicKey;
...
exports.AccountLinkedPrivateKey = AccountLinkedPrivateKey;
