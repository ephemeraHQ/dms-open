...
exports.GrpcStatus = exports.ApiUrls = exports.SortDirection = exports.MessageApi = void 0;
const proto_1 = require("@xmtp/proto");
const utils_1 = require("./utils");
const AuthCache_1 = __importDefault(require("./authn/AuthCache"));
const package_json_1 = require("../package.json");
const constants_1 = require("./constants");
exports.MessageApi = proto_1.messageApi.MessageApi, exports.SortDirection = proto_1.messageApi.SortDirection;
...
class ApiClient {
    constructor(pathPrefix, opts) {
        ...
        this.version = 'xmtp-js/' + package_json_1.version;
        if (pathPrefix === exports.ApiUrls.dev) {
            console.info(constants_1.XMTP_DEV_WARNING);
        }
    }
    // Raw method for querying the API
    _query(req) {
        return (0, utils_1.retry)(exports.MessageApi.Query, [
            req,
            {
    ...
    _batchQuery(req) {
        return (0, utils_1.retry)(exports.MessageApi.BatchQuery, [
            req,
            {
                pathPrefix: this.pathPrefix,
                mode: 'cors',
    ...
    _publish(req, attemptNumber = 0) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield (0, utils_1.retry)(exports.MessageApi.Publish, [
                    req,
                    {
                        pathPrefix: this.pathPrefix,
                        mode: 'cors',
    ...
    _subscribe(req, cb) {
        ...
        const doSubscribe = () => __awaiter(this, void 0, void 0, function* () {
            while (true) {
                ...
                try {
                    yield exports.MessageApi.Subscribe(req, cb, {
                        pathPrefix: this.pathPrefix,
    ...
    query(params, { direction = exports.SortDirection.SORT_DIRECTION_ASCENDING, limit, }) {
        var e_1, _a;
        return __awaiter(this, void 0, void 0, function* () {
            const out = [];
            try {
    ...
    queryIteratePages({ contentTopic, startTime, endTime }, { direction, pageSize = 10 }) {
        ...
        return __asyncGenerator(this, arguments, function* queryIteratePages_1() {
            ...
            const startTimeNs = (0, utils_1.toNanoString)(startTime);
            const endTimeNs = (0, utils_1.toNanoString)(endTime);
            let cursor;
            while (true) {
                const pagingInfo = {
                    limit: pageSize,
            ...
            for (let i = 0; i < queries.length; i += BATCH_SIZE) {
                ...
                for (const queryParams of queriesInBatch) {
                    constructedQueries.push({
                        ...
                        startTimeNs: (0, utils_1.toNanoString)(queryParams.startTime),
                        endTimeNs: (0, utils_1.toNanoString)(queryParams.endTime),
                        pagingInfo: {
                            limit: queryParams.pageSize || 10,
                            direction: queryParams.direction || exports.SortDirection.SORT_DIRECTION_ASCENDING,
                        },
                    });
                }
    ...
    publish(messages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { contentTopic, message, timestamp } of messages) {
                ...
                toSend.push({
                    contentTopic,
                    timestampNs: (0, utils_1.toNanoString)(dt),
    ...
    setAuthenticator(authenticator, cacheExpirySeconds) {
        this.authCache = new AuthCache_1.default(authenticator, cacheExpirySeconds);
    }
    headers() {
