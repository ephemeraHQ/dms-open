...
export declare class MessageV2 extends MessageBase implements proto.MessageV2 {
    senderAddress: string | undefined;
    private header;
    constructor(id: string, bytes: Uint8Array, obj: proto.Message, header: proto.MessageHeaderV2);
    static create(obj: proto.Message, header: proto.MessageHeaderV2, bytes: Uint8Array): Promise<MessageV2>;
    get sent(): Date;
}
